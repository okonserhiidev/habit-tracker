...
> Последнее обновление: 2026-03-19 (frontend active, edit screen + HabitMonthStrip added)
...
- [ ] Микроанимация при отметке (pulse в цвете привычки)
- [x] Прогресс-бар дня ("5 из 7")
- [ ] Анимация "Perfect Day!"
...
### 4.6 Аналитика
- [ ] Статистика привычки (%, лучшие дни)
- [ ] Line chart — тренд по дням
...
### 4.8 Дополнительно
- [ ] Онбординг (приветствие + шаблоны привычек)
- [ ] Экран достижений
